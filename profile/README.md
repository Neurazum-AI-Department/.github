...
- **Vbai-{x.y}{Task} (e.g., Vbai-2.6TS, Vbai-2.7AD, Vbai-3.0PD)**  
  Fully **open-source** models designed to perform multi-domain biomedical tasks.  
  The major version number (e.g., 2.0 → 3.0) changes with the addition of new core features.  
  Example: **Vbai-2.6TS** enables complex tumor annotation and volume estimation by supporting **tumor segmentation** in brain tissue.

  These models can detect structural and degenerative anomalies in real time by directly processing 3D brain MRI inputs. (Does not work with 2D brain images; designed for professional research.)
...
## **Web:** [Neurazum](https://neurazum.com/)  
## **AI Systems Privacy Policy:** [Privacy Policy](https://neurazum.com/yapay-zeka/)
